 ...
 *
 * ----
 * taken from https://gist.github.com/zokipirlo/dc7ae3a6bfc1c6e6b3e369fabb50704c
 */
...
Java_de_lifecapture_phonexrapp_OpenGLRenderer_initContext(
...
JNIEXPORT jlong JNICALL
Java_de_lifecapture_phonexrapp_OpenGLRenderer_initAdditionalContext(
...
Java_de_lifecapture_phonexrapp_OpenGLRenderer_setWindowSurface(
...
Java_de_lifecapture_phonexrapp_OpenGLRenderer_getTexName(
        JNIEnv *env, jclass clazz, jlong context) {
    auto *nativeContext = reinterpret_cast<NativeContext *>(context);
...
JNIEXPORT jboolean JNICALL
Java_de_lifecapture_phonexrapp_OpenGLRenderer_makeCurrent(
        JNIEnv *env, jclass clazz, jlong context) {
    auto *nativeContext = reinterpret_cast<NativeContext *>(context);
...
Java_de_lifecapture_phonexrapp_OpenGLRenderer_setViewPort(
        JNIEnv *env, jclass clazz, jint width, jint height) {
glViewport(0, 0, width, height);
}

JNIEXPORT jboolean JNICALL
        Java_de_lifecapture_phonexrapp_OpenGLRenderer_renderTexture(
...
JNIEXPORT void JNICALL
Java_de_lifecapture_phonexrapp_OpenGLRenderer_closeContext(
        JNIEnv *env, jclass clazz, jlong context) {
auto *nativeContext = reinterpret_cast<NativeContext *>(context);
...
JNIEXPORT void JNICALL
Java_de_lifecapture_phonexrapp_OpenGLRenderer_closeAdditionalContext(
        JNIEnv *env, jclass clazz, jlong context) {
auto *nativeContext = reinterpret_cast<NativeContext *>(context);
DestroySurface(nativeContext);
delete nativeContext;
